...
export class TweetGrpcControllerBase {
  ...
  @GrpcMethod("TweetService", "findManyComments")
  ...
  @GrpcMethod("TweetService", "connectComments")
  ...
  @GrpcMethod("TweetService", "updateComments")
  ...
  @GrpcMethod("TweetService", "disconnectComments")
