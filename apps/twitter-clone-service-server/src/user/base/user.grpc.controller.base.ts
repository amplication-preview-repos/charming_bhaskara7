...
export class UserGrpcControllerBase {
  ...
  @GrpcMethod("UserService", "findManyComments")
  ...
  @GrpcMethod("UserService", "connectComments")
  ...
  @GrpcMethod("UserService", "updateComments")
  ...
  @GrpcMethod("UserService", "disconnectComments")
